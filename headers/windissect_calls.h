...
static constexpr wchar_t module_name[29] = {0x0057, 0x0069, 0x006E, 0x0064, 0x006F, 0x0077, 0x0073, 0x002E, 0x0055, 0x0049, 0x002E, 0x0058, 0x0061, 0x006D, 0x006C, 0x002E, 0x0043, 0x006F, 0x006E, 0x0074, 0x0072, 0x006F, 0x006C, 0x0073, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 840954857U || rva >= image_size) return nullptr;
return base + rva;
}
