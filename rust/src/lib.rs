//! Windissect-generated Rust FFI bindings for Windows.UI.Xaml.Controls.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "8036AD938B1981120265E322C90672FB";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 840954857;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 29] = [87, 105, 110, 100, 111, 119, 115, 46, 85, 73, 46, 88, 97, 109, 108, 46, 67, 111, 110, 116, 114, 111, 108, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 840954857 { return 0; }
